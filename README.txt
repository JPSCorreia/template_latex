The 'main.tex' loads in all the .tex files for the preamble, title page and different sections. It is also responsible for adding a ToC, bibliography and appendices. 
